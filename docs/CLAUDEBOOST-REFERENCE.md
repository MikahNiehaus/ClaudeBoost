...
- Must satisfy the research gate (`clean-rag/hooks/research-gate.py`) before editing any non-exempt file
...
**Triggers:** research RAG, workspace RAG, external source indexing, per-task research, index external docs  
