<!-- Source: https://docs.python.org/3/deprecations/index.html | Tier: A | Topic: python-deprecation | Fetched: 2026-06-26 -->
...
## Pending removal in Python 3.15¶
  ...
  * [`sysconfig`](../library/sysconfig.html#module-sysconfig "sysconfig: Python's configuration information"):
    ...
    * The _check_home_ argument of [`sysconfig.is_python_build()`](../library/sysconfig.html#sysconfig.is_python_build "sysconfig.is_python_build") has been deprecated since Python 3.12.
...
Users should use [`asyncio.run()`](../library/asyncio-runner.html#asyncio.run "asyncio.run") or [`asyncio.Runner`](../library/asyncio-runner.html#asyncio.Runner "asyncio.Runner") with _loop_factory_ to use the desired event loop implementation.
...
The following APIs will be removed in the future, although there is currently no date scheduled for their removal.
  ...
  * [`argparse`](../library/argparse.html#module-argparse "argparse: Command-line option and argument parsing library."):
    ...
    * Passing the undocumented keyword argument _prefix_chars_ to [`add_argument_group()`](../library/argparse.html#argparse.ArgumentParser.add_argument_group "argparse.ArgumentParser.add_argument_group") is now deprecated.
  ...
  * [`importlib`](../library/importlib.html#module-importlib "importlib: The implementation of the import machinery."):
    ...
    * [`cache_from_source()`](../library/importlib.html#importlib.util.cache_from_source "importlib.util.cache_from_source") _debug_override_ parameter is deprecated: use the _optimization_ parameter instead.
