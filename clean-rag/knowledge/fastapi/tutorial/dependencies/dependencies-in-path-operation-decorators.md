<!-- Source: github.com/fastapi/fastapi/docs/en/docs/tutorial\dependencies\dependencies-in-path-operation-decorators.md | Tier: A | Topic: fastapi | Fetched: 2026-06-26 -->
