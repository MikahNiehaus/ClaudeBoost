<!-- Source: github.com/dotnet/docs/docs/core\diagnostics\built-in-metrics-diagnostics.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
You can enable these metrics by calling the <xref:Microsoft.Extensions.DependencyInjection.CommonHealthChecksExtensions.AddTelemetryHealthCheckPublisher*> extension method. These metrics can only be enabled for push-based metrics and aren't available for pull-based metrics.
