<!-- Source: github.com/dotnet/docs/docs/core\diagnostics\built-in-metrics-system-net.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
| Name     | Instrument Type | Unit (UCUM) | Description    |
| -------- | --------------- | ----------- | -------------- |
| [`http.client.request.duration`](https://opentelemetry.io/docs/specs/semconv/dotnet/dotnet-http-metrics/#metric-httpserverrequestduration) | <xref:System.Diagnostics.Metrics.Histogram`1> | `s` | The duration of outbound HTTP requests. |
...
| Name     | Instrument Type | Unit (UCUM) | Description    |
| -------- | --------------- | ----------- | -------------- |
| [`http.client.request.time_in_queue`](https://opentelemetry.io/docs/specs/semconv/dotnet/dotnet-http-metrics/#metric-httpclientrequesttime_in_queue) | <xref:System.Diagnostics.Metrics.Histogram`1> | `s` | The amount of time requests spent on a queue waiting for an available connection. |
