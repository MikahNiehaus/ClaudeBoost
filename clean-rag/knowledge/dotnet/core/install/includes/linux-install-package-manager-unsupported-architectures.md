<!-- Source: github.com/dotnet/docs/docs/core\install\includes\linux-install-package-manager-unsupported-architectures.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
