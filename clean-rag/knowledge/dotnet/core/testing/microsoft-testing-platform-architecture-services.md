<!-- Source: github.com/dotnet/docs/docs/core\testing\microsoft-testing-platform-architecture-services.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
The `IOutputDeviceDataProducer` extends the [`IExtension`](./microsoft-testing-platform-architecture-test-framework.md#the-iextension-interface) and provides information about the sender to the *output device*.
