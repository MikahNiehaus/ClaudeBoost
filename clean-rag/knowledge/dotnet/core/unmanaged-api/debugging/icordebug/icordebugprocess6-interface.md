<!-- Source: github.com/dotnet/docs/docs/core\unmanaged-api\debugging\icordebug\icordebugprocess6-interface.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
|[MarkDebuggerAttached Method](icordebugprocess6-markdebuggerattached-method.md)|Changes the internal state of the debugee so that the <xref:System.Diagnostics.Debugger.IsAttached*?displayProperty=nameWithType> method returns `true`.|
