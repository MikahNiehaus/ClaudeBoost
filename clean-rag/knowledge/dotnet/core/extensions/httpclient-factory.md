<!-- Source: github.com/dotnet/docs/docs/core\extensions\httpclient-factory.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
There are several additional configuration options for controlling the `IHttpClientBuilder`:
