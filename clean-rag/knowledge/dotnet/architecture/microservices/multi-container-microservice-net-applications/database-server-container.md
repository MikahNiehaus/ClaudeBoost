<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\multi-container-microservice-net-applications\database-server-container.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
