<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\multi-container-microservice-net-applications\integration-event-based-microservice-communications.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
![A diagram showing the basic publish/subscribe pattern.](./media/integration-event-based-microservice-communications/publish-subscribe-basics.png)
