<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\implement-resilient-applications\use-httpclientfactory-to-implement-resilient-http-requests.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
