<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\implement-resilient-applications\implement-resilient-entity-framework-core-sql-connections.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
