<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\implement-resilient-applications\handle-partial-failure.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
