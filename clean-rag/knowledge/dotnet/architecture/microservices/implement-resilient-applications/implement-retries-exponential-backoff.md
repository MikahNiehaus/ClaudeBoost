<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\implement-resilient-applications\implement-retries-exponential-backoff.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
