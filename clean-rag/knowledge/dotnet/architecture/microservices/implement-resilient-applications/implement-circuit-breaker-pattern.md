<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\implement-resilient-applications\implement-circuit-breaker-pattern.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
