<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\architect-microservice-container-applications\service-oriented-architecture.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
