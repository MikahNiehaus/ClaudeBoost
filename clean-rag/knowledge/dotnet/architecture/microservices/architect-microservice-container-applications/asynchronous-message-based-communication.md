<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\architect-microservice-container-applications\asynchronous-message-based-communication.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
