<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\architect-microservice-container-applications\communication-in-microservice-architecture.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
