<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\container-docker-introduction\docker-terminology.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
