<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\microservice-ddd-cqrs-patterns\infrastructure-persistence-layer-design.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
