<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\microservice-ddd-cqrs-patterns\client-side-validation.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
