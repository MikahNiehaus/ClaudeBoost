<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\microservice-ddd-cqrs-patterns\microservice-application-layer-web-api-design.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
