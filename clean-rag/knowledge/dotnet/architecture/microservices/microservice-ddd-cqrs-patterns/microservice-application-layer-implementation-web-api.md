<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\microservice-ddd-cqrs-patterns\microservice-application-layer-implementation-web-api.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
...
![Diagram showing the high-level data flow from the client to database.](./media/microservice-application-layer-implementation-web-api/high-level-writes-side.png)
