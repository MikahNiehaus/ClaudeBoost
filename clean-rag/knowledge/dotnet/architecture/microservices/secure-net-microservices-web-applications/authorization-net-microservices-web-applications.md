<!-- Source: github.com/dotnet/docs/docs/architecture\microservices\secure-net-microservices-web-applications\authorization-net-microservices-web-applications.md | Tier: A | Topic: dotnet | Fetched: 2026-06-26 -->
