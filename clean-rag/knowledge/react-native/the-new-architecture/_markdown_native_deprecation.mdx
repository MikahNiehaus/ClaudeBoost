<!-- Source: github.com/facebook/react-native-website/docs/the-new-architecture\_markdown_native_deprecation.mdx | Tier: A | Topic: react-native | Fetched: 2026-06-26 -->
