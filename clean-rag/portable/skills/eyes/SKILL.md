---
name: eyes
description: WHEN doing browser QA, fixing UI issues, or when users express dissatisfaction with visual appearance or behavior; use Playwright MCP to capture screenshots and run a structured visual feedback loop. USE before calling any UI change done.
---
...
- **`frontend-design`** — Distinctive, opinionated visual design: palette, typography, anti-generic-defaults doctrine, two-pass plan-then-build process
