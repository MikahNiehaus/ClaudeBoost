<!-- Source: https://sbert.net/docs/cross_encoder/usage/usage.html | Tier: A | Topic: rag-reranking | Fetched: 2026-06-23 -->
...
Cross Encoder
  ...
  * [Pretrained Models](../pretrained_models.html)
    * [MS MARCO](../pretrained_models.html#ms-marco)
    * [SQuAD (QNLI)](../pretrained_models.html#squad-qnli)
    * [STSbenchmark](../pretrained_models.html#stsbenchmark)
    * [Quora Duplicate Questions](../pretrained_models.html#quora-duplicate-questions)
    * [NLI](../pretrained_models.html#nli)
    * [Multimodal Rerankers](../pretrained_models.html#multimodal-rerankers)
    * [Community Models](../pretrained_models.html#community-models)
...
Documentation
  ...
  1. [`CrossEncoder`](../../package_reference/cross_encoder/model.html#sentence_transformers.cross_encoder.model.CrossEncoder "sentence_transformers.cross_encoder.model.CrossEncoder")

  2. [`CrossEncoder.predict`](../../package_reference/cross_encoder/model.html#sentence_transformers.cross_encoder.model.CrossEncoder.predict "sentence_transformers.cross_encoder.model.CrossEncoder.predict")

  3. [`CrossEncoder.rank`](../../package_reference/cross_encoder/model.html#sentence_transformers.cross_encoder.model.CrossEncoder.rank "sentence_transformers.cross_encoder.model.CrossEncoder.rank")
...
MS Marco models return logits rather than scores between 0 and 1. Load the [`CrossEncoder`](../../package_reference/cross_encoder/model.html#sentence_transformers.cross_encoder.model.CrossEncoder "sentence_transformers.cross_encoder.model.CrossEncoder") with `activation_fn=torch.nn.Sigmoid()` to get scores between 0 and 1. This does not affect the ranking.
...
[ Previous](../../sentence_transformer/training/distributed.html "Distributed Training") [Next ](../../../examples/cross_encoder/applications/README.html "Cross-Encoders")
