<!-- Source: https://huggingface.co/BAAI/bge-reranker-base | Tier: A | Topic: rag-reranking | Fetched: 2026-06-23 -->
...
Beijing Academy of Artificial Intelligence 3.89k

[ Text Classification ](/models?pipeline_tag=text-classification)[ sentence-transformers ](/models?library=sentence-transformers)[ PyTorch ](/models?library=pytorch)[ ONNX ](/models?library=onnx)[ Safetensors ](/models?library=safetensors)[ English ](/models?language=en)[ Chinese ](/models?language=zh)[ xlm-roberta ](/models?other=xlm-roberta)[ mteb ](/models?other=mteb)[ text-embeddings-inference ](/models?other=text-embeddings-inference)[ Eval Results (legacy) ](/models?other=model-index)

arxiv: 5 papers

License: mit

[ Model card ](/BAAI/bge-reranker-base)[ Files Files and versions xet ](/BAAI/bge-reranker-base/tree/main)[ Community 27 ](/BAAI/bge-reranker-base/discussions)
...
### Instructions to use BAAI/bge-reranker-base with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  ...
  * Libraries
  * [ sentence-transformers](/BAAI/bge-reranker-base?library=sentence-transformers)
...
How to use BAAI/bge-reranker-base with sentence-transformers:
  ...
  * Inference Providers
  * Notebooks
  * [ Google Colab](/BAAI/bge-reranker-base/colab)
  * [ Kaggle](/BAAI/bge-reranker-base/kaggle)
...
[English](/BAAI/bge-reranker-base/blob/main/README.md) | [中文](https://github.com/FlagOpen/FlagEmbedding/blob/master/README_zh.md)
...
More
  ...
  * 08/09/2023: BGE Models are integrated into **Langchain** , you can use it like this; C-MTEB **leaderboard** is [available](https://huggingface.co/spaces/mteb/leaderboard). 
...
[BAAI/llm-embedder](https://huggingface.co/BAAI/llm-embedder) | English | [Inference](/BAAI/bge-reranker-base/blob/main/./FlagEmbedding/llm_embedder/README.md) [Fine-tune](/BAAI/bge-reranker-base/blob/main/./FlagEmbedding/llm_embedder/README.md) | a unified embedding model to support diverse retrieval augmentation needs for LLMs | See [README](/BAAI/bge-reranker-base/blob/main/./FlagEmbedding/llm_embedder/README.md)  
[BAAI/bge-reranker-large](https://huggingface.co/BAAI/bge-reranker-large) | Chinese and English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/reranker) | a cross-encoder model which is more accurate but less efficient [2] |   
[BAAI/bge-reranker-base](https://huggingface.co/BAAI/bge-reranker-base) | Chinese and English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/reranker) | a cross-encoder model which is more accurate but less efficient [2] |   
[BAAI/bge-large-en-v1.5](https://huggingface.co/BAAI/bge-large-en-v1.5) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-base-en-v1.5](https://huggingface.co/BAAI/bge-base-en-v1.5) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-small-en-v1.5](https://huggingface.co/BAAI/bge-small-en-v1.5) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-large-zh-v1.5](https://huggingface.co/BAAI/bge-large-zh-v1.5) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `为这个句子生成表示以用于检索相关文章：`  
[BAAI/bge-base-zh-v1.5](https://huggingface.co/BAAI/bge-base-zh-v1.5) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `为这个句子生成表示以用于检索相关文章：`  
[BAAI/bge-small-zh-v1.5](https://huggingface.co/BAAI/bge-small-zh-v1.5) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | version 1.5 with more reasonable similarity distribution | `为这个句子生成表示以用于检索相关文章：`  
[BAAI/bge-large-en](https://huggingface.co/BAAI/bge-large-en) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | :trophy: rank **1st** in [MTEB](https://huggingface.co/spaces/mteb/leaderboard) leaderboard | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-base-en](https://huggingface.co/BAAI/bge-base-en) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | a base-scale model but with similar ability to `bge-large-en` | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-small-en](https://huggingface.co/BAAI/bge-small-en) | English | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | a small-scale model but with competitive performance | `Represent this sentence for searching relevant passages: `  
[BAAI/bge-large-zh](https://huggingface.co/BAAI/bge-large-zh) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | :trophy: rank **1st** in [C-MTEB](https://github.com/FlagOpen/FlagEmbedding/tree/master/C_MTEB) benchmark | `为这个句子生成表示以用于检索相关文章：`  
[BAAI/bge-base-zh](https://huggingface.co/BAAI/bge-base-zh) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | a base-scale model but with similar ability to `bge-large-zh` | `为这个句子生成表示以用于检索相关文章：`  
[BAAI/bge-small-zh](https://huggingface.co/BAAI/bge-small-zh) | Chinese | Inference [Fine-tune](https://github.com/FlagOpen/FlagEmbedding/tree/master/examples/finetune) | a small-scale model but with competitive performance | `为这个句子生成表示以用于检索相关文章：`  
...
`baai-general-embedding` models achieve **state-of-the-art performance on both MTEB and C-MTEB leaderboard!** For more details and evaluation tools see our [scripts](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB/README.md). 
...
[sgpt-bloom-7b1-msmarco](https://huggingface.co/bigscience/sgpt-bloom-7b1-msmarco) | 4096 | 2048 | 57.59 | 48.22 | 38.93 | 81.9 | 55.65 | 77.74 | 33.6 | 66.19  
  ...
  * **C-MTEB** :  
We create the benchmark C-MTEB for Chinese text embedding which consists of 31 datasets from 6 tasks. Please refer to [C_MTEB](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB/README.md) for a detailed introduction.
...
[text2vec-large](https://huggingface.co/GanymedeNil/text2vec-large-chinese) | 1024 | 47.36 | 41.94 | 44.97 | 70.86 | 60.66 | 49.16 | 30.02  
  ...
  * **Reranking** : See [C_MTEB](https://github.com/FlagOpen/FlagEmbedding/blob/master/C_MTEB/) for evaluation script.
...
[ Text Classification](/tasks/text-classification "Learn more about text-classification")
...
##  Model tree for BAAI/bge-reranker-base [](/docs/hub/model-cards#specifying-a-base-model)

Adapters

[1 model](/models?other=base_model:adapter:BAAI/bge-reranker-base)

Finetunes

[22 models](/models?other=base_model:finetune:BAAI/bge-reranker-base)

Quantizations

[22 models](/models?other=base_model:quantized:BAAI/bge-reranker-base)

##  Spaces using BAAI/bge-reranker-base 100

[📚 build-small-hackathon/Omniscient-Novel-Reader ](/spaces/build-small-hackathon/Omniscient-Novel-Reader)[📊 hysts/daily-papers ](/spaces/hysts/daily-papers)[🥇 mteb/leaderboard_legacy ](/spaces/mteb/leaderboard_legacy)[🥇 SmileXing/leaderboard ](/spaces/SmileXing/leaderboard)[🐨 Zulelee/langchain-chatchat ](/spaces/Zulelee/langchain-chatchat)[🏥 kbsss/medical-qa-chatbot ](/spaces/kbsss/medical-qa-chatbot)[🏥 kbsss/healthcare-qa-api ](/spaces/kbsss/healthcare-qa-api)[🌖 umairali64488/doctor ](/spaces/umairali64488/doctor) \+ 95 Spaces \+ 92 Spaces

##  Collection including BAAI/bge-reranker-base

#### [BGE Collection 31 items • Updated Feb 4 • 164](/collections/BAAI/bge)

##  Papers for BAAI/bge-reranker-base

#### [Soaring from 4K to 400K: Extending LLM's Context with Activation Beacon Paper • 2401.03462 • Published Jan 7, 2024 • 29 ](/papers/2401.03462)#### [Making Large Language Models A Better Foundation For Dense Retrieval Paper • 2312.15503 • Published Dec 24, 2023 • 2 ](/papers/2312.15503)#### [LM-Cocktail: Resilient Tuning of Language Models via Model Merging Paper • 2311.13534 • Published Nov 22, 2023 • 3 ](/papers/2311.13534)#### [Retrieve Anything To Augment Large Language Models Paper • 2310.07554 • Published Oct 11, 2023 • 6 ](/papers/2310.07554)#### [C-Pack: Packaged Resources To Advance General Chinese Embedding Paper • 2309.07597 • Published Sep 14, 2023 • 2 ](/papers/2309.07597)

##  Evaluation results [](https://huggingface.co/docs/hub/eval-results)

  * map on MTEB CMedQAv1

[test set](/BAAI/bge-reranker-base/blob/main/README.md) [self-reported](/BAAI/bge-reranker-base/blob/main/README.md)
...
[self-reported](/BAAI/bge-reranker-base/blob/main/README.md)
