<!-- Source: https://huggingface.co/BAAI/bge-reranker-large | Tier: A | Topic: rag-reranking | Fetched: 2026-06-23 -->
...
[ Feature Extraction ](/models?pipeline_tag=feature-extraction)[ Transformers ](/models?library=transformers)[ PyTorch ](/models?library=pytorch)[ ONNX ](/models?library=onnx)[ Safetensors ](/models?library=safetensors)[ English ](/models?language=en)[ Chinese ](/models?language=zh)[ xlm-roberta ](/models?other=xlm-roberta)[ text-classification ](/models?other=text-classification)[ mteb ](/models?other=mteb)[ Eval Results (legacy) ](/models?other=model-index)[ text-embeddings-inference ](/models?other=text-embeddings-inference)

arxiv: 5 papers

License: mit

[ Model card ](/BAAI/bge-reranker-large)[ Files Files and versions xet ](/BAAI/bge-reranker-large/tree/main)[ Community 29 ](/BAAI/bge-reranker-large/discussions)
...
### Instructions to use BAAI/bge-reranker-large with libraries, inference providers, notebooks, and local apps. Follow these links to get started.
  ...
  * Libraries
  * [ Transformers](/BAAI/bge-reranker-large?library=transformers)
...
How to use BAAI/bge-reranker-large with Transformers:
  ...
  * Inference Providers
  * Notebooks
  * [ Google Colab](/BAAI/bge-reranker-large/colab)
  * [ Kaggle](/BAAI/bge-reranker-large/kaggle)
...
[English](/BAAI/bge-reranker-large/blob/main/README.md) | [中文](https://github.com/FlagOpen/FlagEmbedding/blob/master/README_zh.md)
...
[BAAI/llm-embedder](https://huggingface.co/BAAI/llm-embedder) | English | [Inference](/BAAI/bge-reranker-large/blob/main/./FlagEmbedding/llm_embedder/README.md) [Fine-tune](/BAAI/bge-reranker-large/blob/main/./FlagEmbedding/llm_embedder/README.md) | a unified embedding model to support diverse retrieval augmentation needs for LLMs | See [README](/BAAI/bge-reranker-large/blob/main/./FlagEmbedding/llm_embedder/README.md)  
...
[ Feature Extraction](/tasks/feature-extraction "Learn more about feature-extraction")
...
##  Model tree for BAAI/bge-reranker-large [](/docs/hub/model-cards#specifying-a-base-model)

Finetunes

[8 models](/models?other=base_model:finetune:BAAI/bge-reranker-large)

Quantizations

[22 models](/models?other=base_model:quantized:BAAI/bge-reranker-large)

##  Spaces using BAAI/bge-reranker-large 93

[📄 anish0634/datascoutai ](/spaces/anish0634/datascoutai)[🥇 mteb/leaderboard_legacy ](/spaces/mteb/leaderboard_legacy)[🥇 SmileXing/leaderboard ](/spaces/SmileXing/leaderboard)[🐨 Zulelee/langchain-chatchat ](/spaces/Zulelee/langchain-chatchat)[📚 z00mP/Simple-RAG-solution ](/spaces/z00mP/Simple-RAG-solution)[🥇 sq66/leaderboard_legacy ](/spaces/sq66/leaderboard_legacy)[🚀 reader-1/1 ](/spaces/reader-1/1)[🥇 shiwan7788/leaderboard-uni ](/spaces/shiwan7788/leaderboard-uni) \+ 88 Spaces \+ 85 Spaces

##  Collection including BAAI/bge-reranker-large

#### [BGE Collection 31 items • Updated Feb 4 • 164](/collections/BAAI/bge)

##  Papers for BAAI/bge-reranker-large
...
[test set](/BAAI/bge-reranker-large/blob/main/README.md) [self-reported](/BAAI/bge-reranker-large/blob/main/README.md)
...
[self-reported](/BAAI/bge-reranker-large/blob/main/README.md)
