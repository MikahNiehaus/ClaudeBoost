    ...
    return {
        ...
        "side_rails": [
            ...
            },
            {
                ...
                "detail": f"Installed globally in ~/.claude/commands/ — available in every project. Includes /boost, /visualize, /review, /audit, /workspace, /consult, /auto, and more.",
                "side": "left",
                "icon": "⌨",
                "accent": "#3498db",
                "responsibilities": [
                    ...
                    "/review — quick A-F grade or --deep for 15-pass parallel",
                    "/workspace — create workspace and plan",
